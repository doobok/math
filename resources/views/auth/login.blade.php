    ...
    <fieldset class="uk-fieldset">
      <div class="uk-margin-small">
        <div class="uk-inline uk-width-1-1">
          ...
          <input class="uk-input uk-border-pill" placeholder="Логін або Email" id="name" type="name" name="name" required autocomplete="name" autofocus>
        </div>
      </div>
      <div class="uk-margin-small">
        <div class="uk-inline uk-width-1-1">
          <span class="uk-form-icon uk-form-icon-flip" data-uk-icon="icon: lock"></span>
          <input class="uk-input uk-border-pill" placeholder="Пароль" id="password" type="password" name="password" required>
        </div>
      </div>
      <div class="uk-margin-small">
