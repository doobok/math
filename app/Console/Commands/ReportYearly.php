...
class ReportYearly extends Command
{
    /**
     ...
     * @var string
     */
    protected $description = 'Річний звіт';
    ...
    {
        $reports = Report::where('type', 'monthly')->orderBy('id', 'desc')->limit(12)->get();
        ...
        if ($reports->count() > 0) {
          ...
          $report->period = Carbon::yesterday()->monthName . ' рік';
          $report->type = 'yearly';
