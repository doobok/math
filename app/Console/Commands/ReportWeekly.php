...
class ReportWeekly extends Command
{
     ...
     * @var string
     */
    protected $description = 'Тижневий звіт';
    ...
    {
        $reports = Report::where('type', 'daily')->whereDate('created_at', '>', Carbon::today()->subDays(7)->toDateString())->get();
        ...
        if ($reports->count() > 0) {
          ...
          $report->period = Carbon::today()->week() . ' тиждень';
          $report->type = 'weekly';
