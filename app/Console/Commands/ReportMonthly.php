...
class ReportMonthly extends Command
{
     ...
     * @var string
     */
    protected $description = 'Місячний звіт';
    ...
    {
        $reports = Report::where('type', 'daily')->whereDate('created_at', '>=', Carbon::yesterday()->startOfMonth()->toDateString())->get();
        ...
        // записуємо дані в звіт, місячний звіт формується навіть при нульовій активності
          $report = new Report;
          ...
          $report->period = Carbon::yesterday()->monthName;
          $report->type = 'monthly';
